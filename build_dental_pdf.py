"""
Generate a formatted PDF report: Naples FL Dental Offices — Low Online Presence Leads
"""
...
from generate_dental_csv import PRACTICES
...
def add_page_decor(canvas, doc):
    ...
    canvas.drawCentredString(w / 2, 0.1 * inch,
        f"Naples FL Dental Office Lead Report  |  Page {doc.page}  |  Researched June 2026  |  Haven Media Inc.")
    canvas.restoreState()
...
def build_pdf():
    output = "naples_dental_lead_report.pdf"
    doc = SimpleDocTemplate(
        ...
        title="Naples FL Dental Office Lead Report",
    ...
    intro_text = [
        ...
        (None, False,
         "<b><font color='#E67E22'>MEDIUM (score 20–44):</font></b>  Facebook-only or one/two platforms "
         "with very low engagement. Good candidates for social media expansion, Instagram setup, and website upgrades."),
        (None, False,
         "<b><font color='#27AE60'>LOW (score 45+):</font></b>  Already established online. "
         "Included for competitive context. Lower priority unless offering YouTube, TikTok, or ad campaigns."),
        ...
        ("Why Dental Offices?", True,
         "Dentistry is one of the most visual medical niches — smile makeovers, whitening, implants, and "
         "before/after transformations are among the highest-performing content categories on Instagram and TikTok. "
         "Yet many Naples dental practices have little to no social presence, making them ideal leads for social "
         "media marketing services."),
        ("Data Sources", True,
         "NPI Registry, Yelp, Healthgrades, WebMD, ADA Dentist Finder, Gulfshore Life, "
    ...
    # ── SUMMARY TABLE ─────────────────────────────────────────────────────────
    story.append(Paragraph(f"All {total} Dental Practices — Quick Reference", ParagraphStyle(
    ...
    for tier, label, desc in [
        ("HIGH",   "HIGH OPPORTUNITY LEADS",
         "These dental practices have zero or near-zero digital presence. "
         "No social media detected across any platform, or an effectively abandoned account. "
         "Most have a basic website only. Best candidates for a full social media and digital marketing build-out."),
        ("MEDIUM", "MEDIUM OPPORTUNITY LEADS",
         "These practices have a minimal presence — typically Facebook-only or accounts with almost no followers. "
         "Good candidates for Instagram setup, content strategy, social media expansion, and website upgrades."),
        ("LOW",    "LOW OPPORTUNITY — FOR REFERENCE",
         "These dental practices have established digital presences and are included for competitive context. "
         "Lower priority unless pitching YouTube, TikTok, paid social campaigns, or engagement strategy."),
    ]:
